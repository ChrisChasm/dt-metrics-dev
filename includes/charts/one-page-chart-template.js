...
function show_template_overview(){
    ...
    let localizedObject = wpApiTemplate // change this object to the one named in ui-menu-and-enqueue.php
...
function sample_api_call( button_data ) {
    ...
    return jQuery.ajax({
        ...
        dataType: "json",
        url: localizedObject.root + 'dt/v1/advanced/'+localizedObject.name_key+'/sample',
